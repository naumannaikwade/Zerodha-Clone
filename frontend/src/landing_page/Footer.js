    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5 pb-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logo.svg" style={{ width: "50%",marginBottom:"1.25rem" }} />
            <p style={{fontSize:"0.825rem", color:"gray"}}>
          ...
          <div className="col">
            <p style={{fontSize:"1.25rem"}} className="links">Company</p>
            <a href="" >About</a>
            <br />
            <a href="" >Products</a>
            <br />
          ...
          <div className="col">
            <p style={{fontSize:"1.25rem"}} className="links">Support</p>
            <a href="" >Contact</a>
            <br />
          ...
          <div className="col">
            <p style={{fontSize:"1.25rem"}} className="links">Account</p>
